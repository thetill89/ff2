...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
let sVersion = 'v.0.812', sLoaded = false
let maxRuns = 100

for (let i = 1; i <= 100; i++) {
	setTimeout(function() {
		var d = document.getElementsByClassName('eventbtn').length
		if (!d) d = ' MISSING'
		console.log(new Date().getSeconds() + '.' + new Date().getMilliseconds() + ': ' + d)
	}, i * 50)
}
...
function solveCaptcha(captcha) {
	...
	$j.get('game/resetmd.php?rscode=' + captcha).done(function() { 
		finishRun() 
	}).fail(function() {
			setSessionTime(10)	
			resetStep = 0
