...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
let sVersion = 'v.0.863', sLoaded = false
...
function msUpgrade() {
	...
	$j.get('game/researchanz.php').done(function(r) {
		...
		$j.get('game/megaidleanz.php').done(function(r) {
			...
			let farm1h = convertValue(farmNow * 60)
			let farmNext = getValue(r.megaidleprominutenext)
			let farm1hNext = convertValue(farmNext * 60)
			...
			let now1h = convertValue(nowFarm * 60)
			let newFarm = nowFarm/runNow*runNext
			let new1h = convertValue(newFarm * 60)
			...
			addStatus2('1h  : ' + pl(farm1h,8) + '  => ' + farm1hNext) 
			...
			addStatus2('1h  : ' + pl(now1h,8) + '  => ' + new1h) 
...
function createButtons() {
	...
	'Cost UI','MS Upgrade','MS Growth','Daily','Production','Clan','Research',
	...
	btn13.onmousedown = function(e) {
		...
		else if (e.which === 3) missionUpgrade()
