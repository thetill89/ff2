...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
let sVersion = 'v.1.080', sLoaded = false
let maxRuns = 80
...
function getMissionStanding(r) {
	let info = [] 
	let pct = r.aktclanquest ? pl(Math.floor(getValue(r.aktclanquest)/getValue(r.aktfullpoints)*100) + '%',4) + pl((r.aktclanquest + ' / ' + r.aktfullpoints), 22) : ''
