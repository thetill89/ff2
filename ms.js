...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
let sVersion = 'v.0.840', sLoaded = false
...
function showClanRanking() {	
		...
		for (date in data) {
			...
			let points = cur[time[time.length-1]].toString()
			//let points = data[entry][Object.keys(data[entry])[Object.keys(data[entry]).length-1]].toString()
