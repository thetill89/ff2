...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
let sVersion = 'v.0.821', sLoaded = false
let maxRuns = 120

initScript()
function initScript() {
	if (typeof hundredbplus === 'object' && document.getElementsByClassName('eventbtn').length) {
		let now = Date.now()
		loadSettings()
		createButtons()
		createUI()
...
function displayStats() {
	...
	document.title = displayTime(getSessionTime()) + (autoPlay ? ' - ' + getLevel() + ' - ' + account : ' - IDLE')
}
